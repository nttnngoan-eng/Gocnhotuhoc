...
(()=>{
 ...
 function renderBooks(filter=''){
   ...
   grid.innerHTML=books.map(b=>{
     ...
     return `<a class="v24-book-card v242-icon-book" href="library.html?v=24.2.15r5r5&book=${encodeURIComponent(b.id)}"><div class="v242-book-icon">${icon}</div><div class="v242-book-info"><div class="v24-book-name">${esc(b.title)}</div>${credit}<div class="v24-book-lessons">${count} bài học</div></div></a>`
   }).join('');
...
/* ===== V24.2.15r5r5 - TIM TRONG TUNG BAI HOC ===== */
document.addEventListener('DOMContentLoaded', () => {
  const article = document.querySelector('.reader-content');
