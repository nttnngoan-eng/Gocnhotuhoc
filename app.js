...
(()=>{
 ...
 function renderBooks(filter=''){
   ...
   grid.innerHTML=books.map(b=>{
     ...
     return `<a class="v24-book-card v242-icon-book" href="library.html?v=24.2.11&book=${encodeURIComponent(b.id)}"><div class="v242-book-icon">${icon}</div><div class="v242-book-info"><div class="v24-book-name">${esc(b.title)}</div>${credit}<div class="v24-book-lessons">${count} bài học</div></div></a>`
   }).join('');
